...
## 2026-09-13 - FormField Accessibility Linking Requirements
...
**Action:** Always link form labels to their inputs using `htmlFor` and `id`, and link hints using `aria-describedby`.
