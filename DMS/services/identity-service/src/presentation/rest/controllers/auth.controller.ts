...
import { ResolveUserScopeUseCase } from '../../../application/usecases/resolve_user_scope.usecase.js';
...
export class AuthController {
  ...
  private resolveScopeUseCase = new ResolveUserScopeUseCase(new InMemoryUserScopeRepository());
