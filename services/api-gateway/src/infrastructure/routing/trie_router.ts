...
export class InMemoryRouteRepository {
  ...
  private seed(): void {
    const services = [
      { prefix: 'sfa', service: 'sfa-service', paths: ['orders', 'visits', 'journey-plans', 'agents', 'order-approvals', 'beat-routes', 'attendance', 'geo-check-in', 'outlet-census', 'outlet-profile'] },
