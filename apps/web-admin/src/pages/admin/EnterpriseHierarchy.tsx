...
export const EnterpriseHierarchy: React.FC<{ role: UserRole }> = ({ role }) => {
  ...
  // ⚡ Bolt: Hoisted string transformation (.toLowerCase()) outside filter loop
  // Expected impact: Eliminates redundant string allocations and CPU cycles on every render,
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        {outlets.reduce((acc, o) => acc + (o.creditLimit || 0), 0).toLocaleString()}{' '}
                        limit
                      </div>
                    </div>
                  </div>
