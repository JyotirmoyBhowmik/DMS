...
export const SyncQueue: React.FC<{ role: UserRole }> = () => {
  ...
  // Combined 3 separate unmemoized `.filter()` passes (O(3N) time complexity) into a single O(N) pass
  // wrapped in `React.useMemo()` to prevent unnecessary recalculations and intermediate array allocations on every render.
