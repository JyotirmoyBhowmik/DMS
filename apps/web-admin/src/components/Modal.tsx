...
export const Modal = () => {
  const { newInvoiceCustomer, handleAddSkuSubmit, newUserEmail, setNewUserEmail, setNewBeatAgent, handleAddUserSubmit, setNewSkuPrice, newBeatAgent, invoices, newBeatName, newInvoiceAmount, handleAddInvoiceSubmit, setNewBeatName, newSkuStock, setNewUserRole, setNewInvoiceCustomer, setNewSkuName, newSkuDistributor, newUserStatus, setActiveModal, newSkuPrice, activeModal, newUserRole, handleAddBeatSubmit, setNewSkuDistributor, newSkuCategory, setNewInvoiceAmount, users, newSkuName, setNewSkuCategory, setNewSkuStock, beatRoutes, inventory, newBeatRadius, setNewBeatRadius, setNewUserStatus } = useApp();
  return (
    <>
